...
public final class FragmentStoreBinding implements ViewBinding {
  ...
  private FragmentStoreBinding(@NonNull LinearLayout rootView,
      @NonNull RecyclerView recyclerViewStore, @NonNull TextView textStoreTitle) {
    this.rootView = rootView;
    this.recyclerViewStore = recyclerViewStore;
    this.textStoreTitle = textStoreTitle;
  }
  ...
  public static FragmentStoreBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.recyclerViewStore;
      RecyclerView recyclerViewStore = ViewBindings.findChildViewById(rootView, id);
      if (recyclerViewStore == null) {
        break missingId;
      }

      id = R.id.textStoreTitle;
      TextView textStoreTitle = ViewBindings.findChildViewById(rootView, id);
      if (textStoreTitle == null) {
        break missingId;
      }

      return new FragmentStoreBinding((LinearLayout) rootView, recyclerViewStore, textStoreTitle);
    }
